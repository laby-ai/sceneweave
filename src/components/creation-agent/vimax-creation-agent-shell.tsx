...
export function VimaxCreationAgentShell() {
  ...
  return (
    ...
    >
      <header className="relative z-50 h-16 shrink-0 border-b border-white/[0.07] bg-[#080b12]/95 backdrop-blur-xl">
        <div
          data-testid="creation-agent-header-inner"
          className="mx-auto flex h-full w-full max-w-[1320px] items-center justify-between px-3 sm:px-6 lg:px-8"
        >
