...
function backgroundPreview(width: 640 | 1080 | 1920) {
  return buildMediaPreviewImageUrl(withBasePath('/home/huiying-creation-agent-story-reel.png'), {
    width,
    ...
    >
      ...
      >
        ...
        <img
          ...
          loading="eager"
          decoding="async"
          className="absolute inset-x-0 top-0 h-[520px] w-full object-cover object-[52%_center] opacity-95 [mask-image:linear-gradient(to_bottom,black_0%,black_46%,rgba(0,0,0,0.72)_66%,transparent_100%)] sm:h-[680px] sm:object-center lg:h-[760px]"
          draggable={false}
        />
      </div>
