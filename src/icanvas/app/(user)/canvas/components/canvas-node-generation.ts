import type { AiTextMessage } from "@/icanvas/services/api/image";
import { imageReferenceLabel } from "@/icanvas/lib/image-reference-prompt";
import { seedanceReferenceLabel } from "@/icanvas/lib/seedance-video";
...
export async function hydrateNodeGenerationContext(context: NodeGenerationContext) {
    const { imageToDataUrl } = await import("@/icanvas/services/image-storage");
