...
import { AssetPickerModal, type InsertAssetPayload } from "@/icanvas/app/(user)/canvas/components/asset-picker-modal";
import { ModelPicker } from "@/icanvas/components/model-picker";
import { PromptSelectDialog } from "@/icanvas/components/prompts/prompt-select-dialog";
import { VideoSettingsPanel, normalizeVideoResolutionValue, normalizeVideoSizeValue, videoSizeLabel } from "@/icanvas/components/video-settings-panel";
import { canvasThemes } from "@/icanvas/lib/canvas-theme";
import { formatBytes, formatDuration } from "@/icanvas/lib/image-utils";
import { boolConfig, isSeedanceVideoConfig, normalizeSeedanceRatio, seedanceReferenceLabel, seedanceVideoReferenceError, seedanceVideoReferenceHint, SEEDANCE_REFERENCE_LIMITS } from "@/icanvas/lib/seedance-video";
import { deleteStoredMedia, resolveMediaUrl, uploadMediaFile } from "@/icanvas/services/file-storage";
import { resolveImageUrl, uploadImage } from "@/icanvas/services/image-storage";
import { createVideoGenerationTask, pollVideoGenerationTask, storeGeneratedVideo, type VideoGenerationTask } from "@/icanvas/services/api/video";
import { useAssetStore } from "@/icanvas/stores/use-asset-store";
import { modelOptionLabel, useConfigStore, useEffectiveConfig, type AiConfig } from "@/icanvas/stores/use-config-store";
import { useThemeStore } from "@/icanvas/stores/use-theme-store";
import type { ReferenceImage } from "@/icanvas/types/image";
import type { ReferenceAudio, ReferenceVideo } from "@/icanvas/types/media";
